...
GLfloat prScale = 2.0f, prNear = 0.1f, prFar = 45.0f;
...
GLuint cubeVertexArray1, cubeVertexArray2, cubeVertexArray3, cubeVertexArray4, objVertexArray;
...
GLfloat translWorld[3] = {0.0f, 0.0f, -3.0f};
